...
const Color kcTextColor = Color(0xff323B4B);
const Color kcPrimaryColor = Color(0xFF008080);
final Color kcPrimaryColorTwo = const Color(0xff008080).withOpacity(0.7);
